...
AccelerometerLanding_node1757930205863 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_landing", transformation_ctx="AccelerometerLanding_node1757930205863")
...
'''
DropFieldsandDuplicates_node1757941993514 = sparkSqlQuery(glueContext, query = SqlQuery3236, mapping = {"myDataSource":Join_node1757930854379}, transformation_ctx = "DropFieldsandDuplicates_node1757941993514")
